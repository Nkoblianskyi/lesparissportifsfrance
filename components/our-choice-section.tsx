  ...
  return (
    <section className="w-full bg-white py-12">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="relative rounded-xl p-6 transition-all duration-300 shadow-xl border-2 bg-gradient-to-br from-blue-100 via-white to-red-100 border-yellow-400 shadow-2xl shadow-yellow-400/30 max-w-4xl mx-auto">
          ...
          <div className="relative z-10">
            ...
            <div className="hidden md:flex md:items-center md:gap-4 lg:gap-6 pt-2">
              ...
              <div className="flex-shrink-0">
                <Button className="font-bold px-6 py-3 text-base border-2 flex items-center gap-2 shadow-lg transition-all hover:scale-105 bg-red-600 hover:bg-red-700 text-white font-bold border-orange-500">
                  VISITER SITE
            ...
            <div className="md:hidden pt-2">
              ...
              {/* Button */}
              <Button className="font-bold w-full py-3 border-2 flex items-center justify-center gap-2 shadow-lg transition-all hover:scale-105 bg-red-600 hover:bg-red-700 text-white font-bold border-orange-500">
                VISITER SITE
                <ExternalLink className="w-4 h-4" />
              </Button>
            </div>

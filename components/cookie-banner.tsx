...
export function CookieBanner() {
  ...
  return (
    <>
      ...
      {!showDetails && (
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-slate-800 text-white shadow-2xl">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-sm text-white leading-tight">
                    ...
                    expérience.
                    <a href="/politique-cookies" className="text-blue-300 hover:text-blue-200 underline ml-1">
                      En savoir plus
                    </a>
                  </p>
                </div>
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="text-red-300 hover:bg-red-900/20 text-xs px-3 py-1 h-8"
                >
                  Refuser
                </Button>
                <Button
